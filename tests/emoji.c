...
int main(int argc, char **argv)
{
	...
	char str[] = {0xF3,0xD2,0x00}; // U+1F1E8 U+1F1F3  (Unicode -> SJIS : NG)
#endif
#ifdef TEST_SOFTBANK
	//char str[] = {0xFB,0xD7,0x00};// U+2122
	//char str[] = {0xF7,0xB2,0x00};  // U+1F195
	char str[] = {0xFB,0xB3,0x00}; // U+1F1E8 U+1F1F3  (Unicode -> SJIS : NG)
#endif
	int final = 0;
	int state = 0;
	int i;
...
#endif
	to_encoding = mbfl_name2no_encoding("UTF-16");
