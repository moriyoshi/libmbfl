...
extern const mbfl_convert_vtbl vtbl_byte4be_wchar;
extern const mbfl_convert_vtbl vtbl_wchar_byte4be;
extern const mbfl_convert_vtbl vtbl_byte4le_wchar;
extern const mbfl_convert_vtbl vtbl_wchar_byte4le;
