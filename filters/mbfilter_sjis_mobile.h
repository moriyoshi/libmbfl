...
extern const mbfl_encoding mbfl_encoding_sjis_pua;
...
extern const struct mbfl_convert_vtbl vtbl_sjis_pua_wchar;
extern const struct mbfl_convert_vtbl vtbl_wchar_sjis_pua;
