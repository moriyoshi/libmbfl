...
extern const mbfl_identify_vtbl vtbl_identify_eucjpwin;
extern const mbfl_convert_vtbl vtbl_eucjpwin_wchar;
extern const mbfl_convert_vtbl vtbl_wchar_eucjpwin;
