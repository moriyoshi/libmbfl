...
extern const mbfl_identify_vtbl vtbl_identify_sjiswin;
extern const mbfl_convert_vtbl vtbl_sjiswin_wchar;
extern const mbfl_convert_vtbl vtbl_wchar_sjiswin;
